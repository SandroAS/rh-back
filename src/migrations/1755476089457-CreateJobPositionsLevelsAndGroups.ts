...
export class CreateJobPositionsLevelsAndGroups1755476089457 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`job_positions\` ADD \`job_title\` varchar(255) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`job_positions\` DROP COLUMN \`job_title\``);
