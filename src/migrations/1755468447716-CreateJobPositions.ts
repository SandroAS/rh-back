...
export class CreateJobPositions1755468447716 implements MigrationInterface {
    name = 'CreateJobPositions1755468447716'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`job_positions\` (\`id\` int NOT NULL AUTO_INCREMENT, \`uuid\` varchar(255) NOT NULL, \`account_id\` int NULL, \`title\` varchar(255) NOT NULL, \`description\` text NULL, \`cbo_code\` varchar(255) NULL, \`base_salary\` decimal(10,2) NULL, \`created_at\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`updated_at\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, UNIQUE INDEX \`IDX_84e582e7e7d0932698536a0181\` (\`uuid\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
